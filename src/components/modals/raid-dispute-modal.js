...
const petitionType = 'raid-dispute'
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const petitionerRaidLeader = interaction.fields.getTextInputValue('petitioner-raid-leader');
        const otherInvolvedRaidLeader = interaction.fields.getTextInputValue('other-raid-leader');
        ...
        .addFields(
            ...
            {name: 'Petitioner Raid Leader:', value: `${petitionerRaidLeader}`},
            {name: 'Other Involved Raid Leader:', value: `${otherInvolvedRaidLeader}`})
        .setTimestamp()
