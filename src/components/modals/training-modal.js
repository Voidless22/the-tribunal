...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const trainerName = interaction.fields.getTextInputValue('trainer-name');
        if (!await utils.validateInput("Account", { accountName: accountUsername, charName: characterName }) ||
            !await utils.validateInput("Character Exists", { charName: trainerName })) {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: 'Trainer Name:', value: `${trainerName}` })
                .setTimestamp()
